...
<script type="text/javascript" src="<%=basePath%>static/jquery-2.1.4/jquery-2.1.4.min.js"></script>
			...
			<div class="top-right">
				...
				<div class="attention">
					...
					<a class="weixin" href="javascript:;"> <img
						src="static/images/top-icon01.png" alt="" />
						...
						href="javascript:;"><img src="static/images/top-icon03.png"
						alt="" /></a> <span>|</span>
				</div>
				...
				<div class="login-form">
					...
					<div class="login-right">
						<div class="controls">
							...
							<input type="text" name="uphone" class="input03 w400">
						</div>
						<div class="controls">
							<div class="login-controls">
								<p>密码：</p>
							...
							<input type="text" name="upad" class="input03 w400">
						</div>
						<div class="controls">
							<div class="login-controls">
								<p>验证码：</p>
							</div>
							<input type="text" class="input03 w250"> <img
								src="static/images/login-code.png" alt="" class="code-img">
	...
	<div class="footer-top">
		<div class="container">
			...
			<div class="footer-nav">
				<dl
					style="background: url(static/images/footer-icon01.png) no-repeat top left;">
					<dt>
				...
				<dl
					style="background: url(static/images/footer-icon02.png) no-repeat top left;">
					<dt>
				...
				<dl
					style="background: url(static/images/footer-icon03.png) no-repeat top left;">
					<dt>
				...
				<dl
					style="background: url(static/images/footer-icon04.png) no-repeat top left;">
					<dt>
				...
				<dl
					style="background: url(static/images/footer-icon05.png) no-repeat top left;">
					<dt>
